...
class TourismModel:
    ...
    def predict(self, X: DataFrame) -> DataFrame:
        logging.info("Entered predict method of TourismModel class")
    ...
    def initiate_model_trainer(self, train_set: DataFrame, test_set: DataFrame) -> None:
        ...
        try:
            ...
            if best_model_score >= base_model_score:
                ...
                tourism_model = TourismModel(preprocessing_obj, best_model)

                logging.info("Created Tourism object with preprocessor and model")

                logging.info("Created best model file path.")

                self.utils.save_object(BEST_MODEL_PATH, tourism_model)
